    ...
    <div className="p-6 flex flex-wrap justify-between border-b border-blueGray-800">
      <div className="w-2/4">
        <div className="flex flex-col h-full">
          ...
          <span className="block pb-4 mb-auto font-medium text-stone-100">
      ...
      <div className="w-1/4">
        <div className="flex flex-col items-end h-full">
          <div className="flex justify-between">
            <button
              className="mr-2 inline-block mb-auto font-medium text-sm text-stone-100 hover:text-gray-200"
              onClick={() => removeItem(data)}
            >
              Remove
            </button>
            <button
              className="inline-block mb-auto font-medium text-sm text-stone-100 hover:text-gray-200"
    ...
    <section className="fixed right-20 top-[242px]">
      <div className="relative">
        <button
          ...
          className="absolute right-0 z-10 bg-rose-950 text-white p-3 rounded-full hover:bg-lime-400 items-center"
        >
          <svg
            width="24"
            height="24"
        ...
        {showCart && (
          <div className="rounded-3xl co bg-red-400">
            <div className="max-w-lg pt-6 pb-8 px-8 mx-auto">
              ...
              <div className="p-6">
                ...
                <button
                  ...
                  className="inline-block w-full px-6 py-3 text-center font-bold text-white bg-rose-950 hover:bg-lime-400 transition duration-200 rounded-full"
                >
